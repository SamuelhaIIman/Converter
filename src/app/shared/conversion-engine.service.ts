...
export class ConversionEngineService {
  ...
  distanceDefs: ConversionDef[] = [
    ...
    new ConversionDef("meter to foots", 3.2808399, 0, 0, "m", "ft"),
  ];

  currencyDefs: ConversionDef[] = [
    new ConversionDef("€ to $", 1.11, 0, 0, "€", "$"),
    new ConversionDef("$ to €", 1/1.11, 0, 0, "$", "€"),
    new ConversionDef("kr to €", 0.090, 0, 0, "kr", "€"),
    new ConversionDef("€ to kr", 1/0.090, 0, 0, "€", "kr"),
  ];
